...
{
    MKCoordinateRegion region = MKCoordinateRegionMake(centerCoordinate, [self coordinateSpanWithMapView:self centerCoordinate:centerCoordinate andZoomLevel:MIN(zoomLevel, (unsigned)28)]);
